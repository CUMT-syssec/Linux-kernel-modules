...
/*
 * Ubuntu's 5.15.0-139 headers expose irq_set_affinity_hint() but not
 * irq_update_affinity_hint(). For this local build tree, map the newer helper
 * to the older exported API.
 */
#ifndef irq_update_affinity_hint
#define irq_update_affinity_hint irq_set_affinity_hint
#endif
