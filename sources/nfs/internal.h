...
/*
 * Ubuntu's 5.15.0-139 headers predate a few NFS capability/fsdata constants
 * used by this local source snapshot. Provide the local fallback values from
 * the source tree so the module can be built against the running kernel
 * headers.
 */
#ifndef NFS_CAP_CASE_INSENSITIVE
#define NFS_CAP_CASE_INSENSITIVE (1U << 6)
#endif

#ifndef NFS_FSDATA_BLOCKED
#define NFS_FSDATA_BLOCKED ((void *)1)
#endif

#ifndef nfs_fhandle_hash
